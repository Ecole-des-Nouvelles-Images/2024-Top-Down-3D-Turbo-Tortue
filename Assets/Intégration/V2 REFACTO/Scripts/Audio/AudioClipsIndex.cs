...
public class AudioClipsIndex
{
    ...
    [field: SerializeField] public  List<AudioClip> FlowersDig { get; private set; }
    ...
    [field: SerializeField] public AudioClip TurtleMoveStart { get; private set; }
    [field: SerializeField] public AudioClip TurtleMove { get; private set; }
    [field: SerializeField] public AudioClip TurtleNitro { get; private set; }
    [field: SerializeField] public AudioClip TurtleEndNitro { get; private set; }
    [field: SerializeField] public AudioClip TurtleTurn { get; private set; }
